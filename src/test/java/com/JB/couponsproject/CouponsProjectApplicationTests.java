...
class CouponsProjectApplicationTests {
	...
	void contextLoads() {
		...
		System.out.println(couponRepository.getCustomerCouponsByCategory(1L,Category.ELECTRICITY));
		System.out.println(couponRepository.findCustomerCouponsByPriceLessThan(1L,20.0));
	}
}
